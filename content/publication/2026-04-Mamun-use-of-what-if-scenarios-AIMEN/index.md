...
summary: "We propose \"Artificial Intelligence (AI) for Modeling and Explaining Neonatal Health\" (AIMEN), a deep learning framework that not only predicts adverse labor outcomes from maternal, fetal, obstetrical, and intrapartum risk factors but also provides the model's reasoning behind the predictions made."
